...
class Tracer extends opentracing.Tracer {
  ...
  _startSpan (name, opts, outerContext = null) {
    let context = null
    ...
    let span = this._agent.currentTransaction === null || this._agent.currentTransaction.ended
      ? this._agent.startTransaction(name, type, { childOf: context, startTime: opts.startTime }, outerContext)
      : this._agent.startSpan(name, type, { childOf: context, startTime: opts.startTime }, outerContext)
    if (!span) {
